...
* Pilih bahasa yang akan digunakan pada server
...
* Pengaturan server. Server akan mengisi kolom persyaratan secara *default* sehingga kolom dapat dibiarkan seperti itu jika memang tidak ingin melakukan perubahan.
...
* Pengaturan database   
  ...
  * Setelah preset mengisi kolom-kolom sebagai *default*, ganti **HOSTNAME = localhost** dan **DATABASE NAME = openfiredb**.
...
* Pengaturan profile. Pilih sistem ***user*** dan ***group*** sesuai dengan kebutuhan. Pada instalasi kali ini, dibiarkan *default*.
